...
- **Неактивный таб**: серый текст `#5d5d68`, при наведении цвет меняется на `#1f2427` (без подчёркивания)
- **Анимация**: плавное появление подчёркивания активного таба через `transition: all 0.3s ease`
