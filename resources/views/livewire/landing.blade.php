...
@section('content')
        ...
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="lead text-muted mx-auto" style="max-width: 680px;">
                    Сбор объединяет всех участников команды в одной системе — от первой заявки в клуб до итогов турнира и личной статистики игрока.
                </p>
            </div>
    ...
    <section id="audience" class="py-5 bg-white">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="lead text-muted mx-auto" style="max-width: 680px;">
                    Сбор подстраивается под вашу роль: тренер получает инструменты управления, родитель — мониторинг, игрок — свой прогресс.
                </p>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-3">
                    <div class="step-card">
                        ...
                        <h5>Регистрация</h5>
                        <p>Создайте аккаунт — это бесплатно и занимает меньше минуты.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="step-card">
                        ...
                        <h5>Создайте клуб</h5>
                        <p>Укажите вид спорта, город и добавьте логотип клуба.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="step-card">
                        ...
                        <h5>Добавьте команды</h5>
                        <p>Сформируйте составы, пригласите тренеров и игроков.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="step-card">
                        ...
                        <h5>Управляйте!</h5>
                        <p>Планируйте тренировки, проводите матчи, следите за прогрессом.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="testimonial-card-new">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="testimonial-avatar" style="background: linear-gradient(135deg, #dcfce7, #bbf7d0); color: #166534;">
                                АП
                            </div>
                            <div>
                ...
                <div class="col-md-4">
                    <div class="testimonial-card-new">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="testimonial-avatar" style="background: linear-gradient(135deg, #dbeafe, #bfdbfe); color: #1e40af;">
                                МИ
                            </div>
                            <div>
                ...
                <div class="col-md-4">
                    <div class="testimonial-card-new">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="testimonial-avatar" style="background: linear-gradient(135deg, #fee2e2, #fecaca); color: #991b1b;">
                                ЕС
                            </div>
                            <div>
    ...
    <section id="cta" class="cta-section py-5 text-white text-center">
        ...
        <div class="cta-decoration" style="top: 20%; left: 10%; font-size: 8rem;">&#9917;</div>
        <div class="cta-decoration" style="bottom: 20%; right: 15%; font-size: 6rem; transform: rotate(30deg);">&#127942;</div>
        <div class="cta-decoration" style="top: 40%; right: 25%; font-size: 4rem; opacity: 0.05;">&#127939;</div>
        ...
        <div class="container position-relative">
            ...
            <!-- Trust indicators -->
            <div class="d-flex flex-wrap justify-content-center gap-4 mt-5 opacity-75">
                <div class="d-flex align-items-center gap-2">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>
                    </svg>
                    <small>Безопасные данные</small>
                </div>
                <div class="d-flex align-items-center gap-2">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <small>Экономия 5+ часов в неделю</small>
                </div>
                <div class="d-flex align-items-center gap-2">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                    ...
                    <small>3000+ спортсменов уже с нами</small>
                </div>
            </div>
        </div>
    </section>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(document.getElementById('chartResults'), {
        ...
        data: {
            ...
            datasets: [
                { label: 'Победы',    data: [5,7,6,9,8,11], backgroundColor: green,    borderRadius: 6 },
                { label: 'Ничьи',     data: [2,1,3,2,1,2],  backgroundColor: amber,    borderRadius: 6 },
                { label: 'Поражения', data: [3,2,1,1,2,0],  backgroundColor: '#ef4444', borderRadius: 6 }
            ]
        },
        options: {
            responsive: true,
