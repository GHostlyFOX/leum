                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{url('club')}}">
                                    <i class="pe-7s-gym side-menu__icon"></i>
                                    <span class="side-menu__label">
                                        Тренировки
                                    </span>
                                </a>
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{url('club')}}">
                                    <i class="fa fa-soccer-ball-o side-menu__icon"></i>
                                    <span class="side-menu__label">
                                        Соревнования
                                    </span>
                                </a>
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{url('club/staff')}}" class="slide-item">
                                    <i class="fa fa-address-card-o side-menu__icon"></i>
                                    <span class="side-menu__label">
                                        Сотрудники
                                    </span>
                                </a>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    <i class="fa fa-files-o side-menu__icon"></i>
