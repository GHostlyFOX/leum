    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0);">Команды</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body project-type-container projects p-4">
                            <h4 class="m-0" id="typeTitle">Добавление команды</h4>
                            <div class="d-sm-flex align-items-center">
                                <div class="btn-list mx-4">
                                    <a class="btn btn-outline-primary" href="/club">
                            ...
                            <div class="col-sm-12">
                                <table id="project-table" class="table text-nowrap mb-0 table-bordered border-top border-bottom project-list-main dataTable no-footer" role="grid" aria-describedby="project-table_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="bg-transparent border-bottom-0 sorting" tabindex="0" aria-controls="project-table" rowspan="1" colspan="1" aria-label="Members: activate to sort column ascending" style="width: 130.8px;">
                                            Игроки
                                        </th>
